...
namespace bomberman
{
    ...
    {
    public:
        explicit ClientMove(direction_t _direction)
    ...
    {
    public:
        explicit InputMove(direction_t _direction)
            : direction(_direction) {}
        direction_t direction;
    ...
    public:
        ...
        void get_message(auto message_handle_callback)
        {
            ...
            case input_message_t::PlaceBomb:
                ...
                input_msg_ptr = std::make_shared<InputPlaceBomb>();
                break;
            case input_message_t::PlaceBlock:
                ...
                input_msg_ptr = std::make_shared<InputPlaceBlock>();
                break;
            case input_message_t::Move:
                ...
                input_msg_ptr = std::make_shared<InputMove>(direction);
                break;
            }
